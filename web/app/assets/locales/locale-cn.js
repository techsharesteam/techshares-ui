module.exports = {
    ...
    wallet: {
        ...
        downoad: "下载",
        import_20_notice1: "请先导入你的THS钱包备份文件",
        ...
        need_backup: "钱包需要备份",
        noneed_backup: "无需备份",
        import_bts1: "从TechShares 0.9.3c导入",
    ...
    init_error: {
        ...
        not_connected: "未连接",
        browser: "不支持的浏览器",
        browser_text: "你使用的浏览器(版本)未经过TechShares钱包软件的充分测试。强烈建议你备份钱包，并将其导入谷歌Chrome浏览器。今后进过我们充分测试后，你或许可以继续使用现在的浏览器。请了解相关风险。",
        understand: "我理解"
    },
    refcode: {
        claim: "领取",
