...
export default class ImportKeys extends Component {
            ...
            <div>
                ...
                <div>
                    <div className="center-content">
                        <div>
                            <div>
                                <label>THS 0.9.x key export file
    ...
    /** THS 1.0 client wallet_export_keys format. */
    _parseImportKeyUpload(json_contents, file_name, update_state) {
        ...
        // THS 1.0 wallets may have a lot of generated but unused keys or spent TITAN addresses making
    ...
    /**
    THS 1.0 hosted wallet backup (wallet.bitshares.org) is supported.
    
    THS 1.0 native wallets should use wallet_export_keys instead of a wallet backup.
    ...
    */
    _parseWalletJson(json_contents) {
        ...
        var savePubkeyAccount = function (pubkey, account_name) {
            ...
            address = "THS" + address.substring(3)
        ...
        try {
            ...
            if( ! encrypted_brainkey)
                throw "Please use a THS 1.0 wallet_export_keys file instead"
