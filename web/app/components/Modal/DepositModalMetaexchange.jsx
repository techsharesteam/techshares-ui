...
class DepositModalMetaexchange extends React.Component {
   ...
   constructor( props ) {
      super(props);
		...
		{
			this.state = {limit:"fetching...", receive_asset_name:"TechShares", receive_asset_symbol:"BTC"};
		}
		else
		{
       ...
       return (<form className="grid-block vertical full-width-content">
                 <div className="grid-container">
                   <div className="content-block">
                      {depositPart}
					  <p>Deposit TechShares by sending a transaction from your {this.props.receive_asset_name} wallet to the address below</p>
                   </div>
                   <div className="content-block full-width-content">
