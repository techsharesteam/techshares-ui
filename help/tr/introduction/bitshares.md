...
Daha önce bahsedildiği gibi , TechShares sadece bir *teknolojiyi* yada *protokolü* 
tarif etmektedir. Fakat fiilen bir  ekosisteme dönüşmesi  TechShares gibi 
gerçek bir blokzinciri ile birlikte mümkün olur.

TechShares , blokzinciri yeniliğini , hizmetlerini internet kullanarak sunan tüm 
...
Bitcoin para için ne yaptıysa TechShares'de işletmeler için onu yapar. Bunu , evrensel, 
şeffaf, güvenilir, verimli ve karlı şirketler yaratmak için dağıtık mutabakat teknolojisini 
kullanarak yapar.

## Bu Cüzdan

Şu an bu tarayıcı penceresinde açık olan cüzdanla TechShares ağının tüm işlevlerine
erişebilirsiniz.
