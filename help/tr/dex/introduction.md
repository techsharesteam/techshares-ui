...
Merkezsiz borsa (kısaca *DEX*) , TechShares ekosisteminde 
...
Bunlardan kısaca bahsetmek istiyoruz. TechShares DEX'de hepsi mevcut olmasina 
...
* **Güçler Ayrılığı** : 
  ...
  kimsenin sorumlu olmasını gerektirecek bir sebep yoktur. TechShares'de işlem 
...
* **Genel Birleşik Emir/Sipariş Defteri** :
  TechShares evrensel olduğu için , internet erişimi olan herkes  DEX'i alım-satım için 
...
* **Neredeyse Herşeyi Alıp-Satabilirsiniz** :
  TechShares DEX varlığın muhteviyatını bilmez , dolayısı ile **her türlü**  eşleşme ticareti 
...
* **Limit Yok** :
  TechShares protokolünün sizin ticaret deneyiminizi sınırlaması mümkün değildir.
* **Merkezsiz** :
  DEX (merkezsiz borsa) tüm dünyaya dağıtıktır. Bölece tek kırılma noktası 
  olmadığı gibi bu TechShares borsasının ticaret için 7/24 açık olduğu anlamına 
...
* **Hızlı** :
  Diğer merkezsiz ağların tersine TechShares DEX gerçek-zamanlı ticarete
   imkan tanır , sadece ışık hızı ve gezegenin büyüklüğü 
  ile sınırlıdır.
* **Kanıtlanabilir Emir Eşleştirme Algoritması** :
  TechShares DEX i nadir kılan şeylerden biri de ispatlanabilir emir eşleştirme 
...
* **Teminata Bağlanmış** :
  TechShares'in en büyük özelliklerinden biri de bitUSD, bitEUR, bitCNY gibi 
  *akıllıparalar*dır. Kolaylık olsun diye bu varlıklar cüzdan içerisinde USD,EUR,CNY 
  ...
  fiyatında hesap görümü için mevcut olabilen, **TechShares'in şirket hisseleri (BTS)** 
   vardır.