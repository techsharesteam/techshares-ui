...
THS'le temasınızı arttırmak ve USD,EUR,GOLD gibi BitAktiflere likidite sağlamak için 
bu BitAktifleri ağdan *ödünç* alabilir ve *kısa satabilirsiniz*. Prosedürü burada kısaca 
anlatacağız.

## Ödünç Alma

TechShares ağının herhangi bir miktarda BitVarlığı piyasaya sürmesi ve yeterli teminat 
karşılığında katılımcılara borç vermesi mümkündür. 

 * *uzlaşma fiyatı* : 1 THS in dış borsalarda alıp-satılırkenki fiyatı.
...
TechShares ağı , ödünç aldığı bitVarlığın karşılığında yeterince teminatı bulunmayan 
...
fiyatından(x/THS) daha düşük olduğu anda teminatı zorla sattırılır.
...
piyasa fiyatından satın alır ve pozisyonu kapar. Teminattan geri kalan THS müşteriye 
iade edilir.
...
teminat oranı arttırılırsa , ilave miktarda THS teminat olarak kilit altına alınır, teminat 
oranının düşürülmesi ise tekabül eden miktarda BitVarlığın ağa geri ödenmesini 
gerektirir.

## Kapamak

Ödünç/kısa pozisyonunu kapamak için , ilk önce kişinin , TechShares ağına teslim 
