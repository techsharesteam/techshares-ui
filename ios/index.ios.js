...
var TechShares = React.createClass({
    render: function () {
        return (
            <NavigatorIOS
                style={styles.nav_container}
                initialRoute={{ title: 'TechShares iOS GUI', component: AccountsList }}/>
        );
    }
});
...
AppRegistry.registerComponent('TechShares', () => TechShares);

module.exports = TechShares;
