...
test = (key) ->
    describe "key_formats", ->
        ...
        it "THS public key import / export", ->
            public_key = PublicKey.fromPublicKeyString key.public_key
            assert.equal key.public_key, public_key.toPublicKeyString()
...
test
    ...
    # https://github.com/TechShares/bitshares/blob/2602504998dcd63788e106260895769697f62b07/libraries/wallet/wallet_db.cpp#L103-L108
