...
TechShares > $g.db.api.exec("get_objects",[["1.2.0"]])
var o=_[0]
o.active
...
TechShares > $g.db.api.exec("get_objects",[["1.2.15"]])
var o=_[0]
o.active
...
TechShares > var tr = $g.wallet.new_transaction()
TechShares > tr.add_type_operation("account_upgrade", {"account_to_upgrade":"1.2.15","upgrade_to_lifetime_member":true})
TechShares > $g.wallet.sign_and_broadcast(tr)
null
